...
\begin{poster}{
 ...
 % University logo
 {
    ...
    \includegraphics[width=\linewidth]{icml_logo.png}
    \end{minipage}
    \makebox[0.02\textwidth]{} 
...
\headerbox{\rmfamily Setup}{name=results,column=2,row=0,span=3}{
    ...
    \begin{center}
        \resizebox{0.55\textwidth}{!}{
            \includegraphics[width=\linewidth]{clf_weight_density_from_training.png}
        }
    \end{center}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{.48\linewidth}
        ...
        \begin{minipage}[b]{0.5\linewidth}
            \begin{center}
            \resizebox{\textwidth}{!}{
                \includegraphics[width=1.1\linewidth]{no_bottleneck_pooling_density_histogram.png}
            }
            No Bottleneck.
            \end{center}
        \end{minipage}%
        ...
        \begin{minipage}[b]{0.5\linewidth}
            \begin{center}
            \resizebox{\textwidth}{!}{
                \includegraphics[width=1.1\linewidth]{bottleneck_pooling_density_histogram.png}
            }
            With Bottleneck.
            \end{center}
        \end{minipage}
